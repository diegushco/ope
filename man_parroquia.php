...
<div class="row-fluid">
			<div class="span12">				
					 <div class="widget-header widget-header-small header-color-blue">
						 <h5><b>Gestión de parroquias</b></h5>
					 </div>
					...
					<form action="" class="form-horizontal" name="formulario" id="formu" method="post"> 
							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
										<tr>
											<td style="padding: 8px 5px;">Nombre de parroquia</td>
											<td style="padding: 8px 100px; ">
											<input  style="width:180px;" type="text" id="parroquia" name="parroquia" onfocus='blanco(this)' title="Ingrese los Datos" />
											</td>
											
		
										</tr>
										<tr>
											<td style="padding: 8px 5px;">Seleccione el Municipio</td>
											<td style="padding: 8px 100px; ">
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarParroquia(document.formulario)">Registrar</button>
			...
			<div class="span12">				
					 <div class="widget-header widget-header-small header-color-orange">
						 <h5><b>Listado de Parroquias</b></h5>
					 </div>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_parroquia.php?hora="+hora,true);

			...
			<div class="span12">				
					...
					<form action="" class="form-horizontal" name="formulario" id="formu" method="post"> 
							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
										<tr>
											<td style="padding: 8px 5px;">Nombre de aldea</td>
											<td style="padding: 8px 100px; ">
											<input  style="width:180px;" type="text" id="aldea" name="aldea" onfocus='blanco(this)' title="Ingrese los Datos" />
											</td>
											
		
										</tr>
										<tr>
											<td style="padding: 8px 5px;">Seleccione la ciudad</td>
											<td style="padding: 8px 100px; ">
												<select data-placeholder="Seleccione" id="parroquia" name="parroquia"  class="chzn-select" >
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarAldea(document.formulario)">Registrar</button>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_aldea.php?hora="+hora,true);

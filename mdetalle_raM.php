							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
									...
									<table>
										<tr>										
											...
											<td colspan="5" style="padding: 8px 0px;"  >
												<textarea id="situacion" class="textarea"><?php echo $row["situacion"]; ?></textarea>
											</td>
											...
											<tr>										
												...
												<td style="padding: 8px 0px;">
													<textarea id="recomendacion"  class="textarea"><?php echo $row["recomendacion"]; ?></textarea>													
												</td>
											...
											<tr>										
												...
												<td style="padding: 8px 0px;">
													<textarea id="observacion"  class="textarea"><?php echo $row["observacion"]; ?></textarea>													
													<input type="hidden" id="oculto" value="<?php echo $_REQUEST["valor"]; ?>" >
												</td>
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="agregar" onClick="modificarRA()">Modificar</button>											
										</div>		
									</div>	

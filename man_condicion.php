							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarCondicion(document.formulario)">Registrar</button>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_Condicion.php?hora="+hora,true);

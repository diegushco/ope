...
<?php
			...
			$consulta="select cf.Nombre as familiar, cc.Id_Censo as idCenso, cvi.Id_Vivienda as idvi,
...
cvi.Id_Vivienda=cc.Id_Vivienda and
				...
				cf.Id_CondicionFamiliar like '%".$_REQUEST["idbus"]."%' 
				";
				//echo $consulta;
		...
		?>
										...
										<tr>
											...
											<td class="hidden-phone"><?php echo $row["familiar"]; ?></td>
...
bitacora("Busca lista de Censo por Cond. Familiar","Buscar",$conexion);
//cierro if ?>

			...
			<div class="span12">				
					...
					<form action="" class="form-horizontal" name="formulario" id="formu" method="post"> 
							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
										<tr>
											<td style="padding: 8px 5px;">Nombre de ciudad</td>
											<td style="padding: 8px 100px; ">
											<input  style="width:180px;" type="text" id="ciudad" name="ciudad" onfocus='blanco(this)' title="Ingrese los Datos" />
											</td>
											
		
										</tr>
										<tr>
											<td style="padding: 8px 5px;">Seleccione la parroquia</td>
											<td style="padding: 8px 100px; ">
												<select data-placeholder="Seleccione" id="municipio" name="municipio"  class="chzn-select" >
															<option value="AL" ></option>
															

															<?php
															include("conexion.php");	
															$sql=mysql_query("SELECT * FROM parroquia order by Nombre asc",$conexion);  
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarCiudad(document.formulario)">Registrar</button>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_ciudad.php?hora="+hora,true);

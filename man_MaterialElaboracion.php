			...
			<div class="span12">				
					...
					<form action="" class="form-horizontal" name="formulario" id="formu" method="post"> 
							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
										<tr>
											<td style="padding: 8px 5px;">Nombre del Material</td>
											<td style="padding: 8px 100px; ">
											<input  style="width:180px;" type="text" id="material" name="material" onfocus='blanco(this)' title="Ingrese los Datos" />
											</td>										
										</tr>
										<tr>
											<td style="padding: 8px 5px;"> <strong>Parte</strong></td>
											 <td style="padding: 8px 100px; ">
												 <select data-placeholder="Seleccione" id="parte" name="parte"   class="chzn-select">
													 <option value="AL" ></option>
													 <option value="AL" >Techo</option>
													 <option value="AK" >Paredes</option>
													 <option value="AZ" >Pisos</option>											 
												 </select>
											 </td>		
										</tr>
										<tr>
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarMaterialElaboracion(document.formulario)">Registrar</button>
...
<div class="row-fluid">
			<div class="span12">				
					 <div class="widget-header widget-header-small header-color-orange">
						 <h5><b>Listado de los Materiales</b></h5>
					 </div>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_MaterialElaboracion.php?hora="+hora,true);

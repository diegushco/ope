	...
	<div class="row-fluid">
		...
		<form class="form-inline">
		   <div class="control-group">
			...
			<a href="javascript: menu('listado_censo_evento')" class="btn btn-small btn-info">
...
$consulta="select ce.Nombre as evento, cc.Id_Censo as idCenso, cvi.Id_Vivienda as idvi,
...
";
		...
		?>
										...
										<tr>
											...
											<td class="hidden-phone"><?php echo $row["evento"]; ?></td>

			...
			<div class="span12">				
					...
					<form action="" class="form-horizontal" name="formulario" id="formu" method="post"> 
							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
										<tr>
											<td style="padding: 8px 5px;">Nombre del Motivo</td>
											<td style="padding: 8px 100px; ">
											<input  style="width:180px;" type="text" id="motivo" name="motivo" onfocus='blanco(this)' title="Ingrese los Datos" />
											</td>										
										</tr>
										<tr>
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarMotivoCenso(document.formulario)">Registrar</button>
...
<div class="row-fluid">
			<div class="span12">				
					 <div class="widget-header widget-header-small header-color-orange">
						 <h5><b>Listado de las condiciones</b></h5>
					 </div>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_Motivos.php?hora="+hora,true);

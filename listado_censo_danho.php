<style type="text/css">
	...
	<div class="page-header position-relative titulo">
		<h2>
			Reporte de Censo por Daño de Vivienda
		</h2>
	</div><!--/.page-header-->
	...
	<div class="row-fluid">
		...
		<form class="form-inline">
		   <div class="control-group">
			...
			<a href="javascript: menu('listado_censo_danho')" class="btn btn-small btn-info">
...
$consulta="select cda.Nombre as danho, cc.Id_Censo as idCenso, cvi.Id_Vivienda as idvi,
...
";
		...
		?>
										...
										<tr>
											...
											<td class="hidden-phone"><?php echo $row["danho"]; ?></td>
...
include("guardaBitacora.php");
					bitacora("Busca censo reporte por daño","Buscar",$conexion);
		...
		$cons="
					...
					select DISTINCT cda.Nombre as Nombre, cda.Id_Danho as Id_Danho
					from cs_afectado csa, cs_otra_propiedad cop, cs_refugio_afectado cra, cs_refugio cr, cs_censo cc, cs_evento ce, funcionario fu, aldea al, cs_motivo cm, cs_condicion_familiar cf, cs_vivienda cvi, cs_danho cda, cs_tenencia cten, cs_tipo ctip, cs_parte cpar, cs_material_elaboracion cmel1, cs_material_elaboracion cmel2, cs_material_elaboracion cmel3
					, ciudad ciu, parroquia parr, municipio mun
					where
					mun.Id_Municipio=parr.Id_Municipio and
		...
		if($row=mysql_fetch_array($sql)){
			...
			while($row=mysql_fetch_array($sql)){
				...
				$consulta1="
				select count(cda.Id_Danho) as cantidad, cda.Nombre
					from cs_afectado csa, cs_otra_propiedad cop, cs_refugio_afectado cra, cs_refugio cr, cs_censo cc, cs_evento ce, funcionario fu, aldea al, cs_motivo cm, cs_condicion_familiar cf, cs_vivienda cvi, cs_danho cda, cs_tenencia cten, cs_tipo ctip, cs_parte cpar, cs_material_elaboracion cmel1, cs_material_elaboracion cmel2, cs_material_elaboracion cmel3
					, ciudad ciu, parroquia parr, municipio mun
					where
					mun.Id_Municipio=parr.Id_Municipio and
					...
					cda.Id_Danho like '%".$row['Id_Danho']."%' ";
					//echo $consulta1;
...
$_SESSION["nombres"]=$nombres;
 ?>
							...
							<img id="grafico" src="graficoBarDanho.php?var=<?php echo time(); ?>" />
							</div>
	</div>	
...
function traeListado(){
			...
			objeto_ajax.open("GET", "trae_CensoDanho.php?hora="+hora+"&fecha1="+fecha1+"&fecha2="+fecha2+"&idbus="+aldea1,true);

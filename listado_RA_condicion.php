	...
	<div class="row-fluid">
		...
		<form class="form-inline">
		   <div class="control-group">
			...
			<a href="javascript: menu('listado_RA_condicion')" class="btn btn-small btn-info">
...
bitacora("Busca reporte RA por condicion ","Buscar",$conexion);
		...
		$aco1=0;
		include("conexion.php");	
		$conm="select DISTINCT rco.Id_Condicion as idti, rco.Nombre as Nombre
				from ra_actividad raa, 
				ra_tipo rat,
				aldea ald,
				ra_accion_actividad rac,
		...
		if($row=mysql_fetch_array($sql)){
			...
			while($row=mysql_fetch_array($sql)){
				...
				$consulta1="select count(rco.Id_Condicion) as cantidad
				from ra_actividad raa, 
				ra_tipo rat,
				aldea ald,
				ra_accion_actividad rac,
				...
				ciud.Id_Parroquia=parr.Id_Parroquia and
				parr.Id_Municipio=muni.Id_Municipio and
				rco.Id_Condicion like '%".$row['idti']."%' ";
...
function traeListado(){
			...
			objeto_ajax.open("GET", "trae_RACondicion.php?hora="+hora+"&fecha1="+fecha1+"&fecha2="+fecha2+"&muni="+aldea1,true);

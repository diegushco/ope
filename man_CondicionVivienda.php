							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarCondicionVivienda(document.formulario)">Registrar</button>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_CondicionVivienda.php?hora="+hora,true);

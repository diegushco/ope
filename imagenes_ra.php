...
<div class="row-fluid">
	<div class="span12">
		...
		<form action="guarda_imagenes.php" method="post" enctype="multipart/form-data" name="formu">	
		<table class="table table-condensed">
			<tbody>
			<tr>
					
					<td colspan="1"><strong>Folio Nº</strong></td>
					<td colspan="1">
						<div class="input-append">
							<input class="input-small input-mask-date" type="text" id="input_folio" name="input_folio" />
							<span class="btn btn-warning">
								<i class="icon-search bigger-110"></i>
								<a style="text-decoration:none;color:white;" href="javascript: buscaFolio()" >Buscar</a> 
							</span>
						</div>
					</td>

			...
			<div class="span12">				
					...
					<form action="" class="form-horizontal" name="formulario" id="formu" method="post"> 
							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
										<tr>
											<td style="padding: 8px 5px;">Nombre del Tipo de Acción</td>
											<td style="padding: 8px 100px; ">
											<input  style="width:180px;" type="text" id="accion" name="accion" onfocus='blanco(this)' title="Ingrese los Datos" />
											</td>										
										</tr>
										<tr>
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarAccionTomada(document.formulario)">Registrar</button>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_AccionTomada.php?hora="+hora,true);

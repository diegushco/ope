...
<?php 
		$fila=0;
			...
			$sql=mysql_query("SELECT * FROM cs_evento order by Id_Evento asc",$conexion);  
									...
									<label>
										...
										<td class="td-actions">
											<div class="hidden-phone visible-desktop action-buttons">
												...
												<a href="javascript: modificaEventoCenso('<?php echo "activo".$fila; ?>','<?php echo "evento".$fila; ?>','<?php echo "viejo".$fila; ?>','<?php echo "descripcion".$fila; ?>')" class="tooltip-success" data-rel="tooltip" title="Modificar">
												<i class="icon-pencil bigger-130"></i>
												</a>
												
												<a href="javascript: eliminaEventoCenso('<?php echo "activo".$fila; ?>','<?php echo "evento".$fila; ?>','<?php echo "viejo".$fila; ?>','<?php echo "descripcion".$fila; ?>')" class="tooltip-success red" data-rel="tooltip" title="Eliminar">

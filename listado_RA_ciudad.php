	...
	<div class="row-fluid">
		...
		<form class="form-inline">
		   <div class="control-group">
			...
			<a href="javascript: menu('listado_RA_ciudad')" class="btn btn-small btn-info">
...
<?php
			include("conexion.php");
			$consulta="select ciud.Nombre as aldea, raa.Id_Actividad as actividad, raa.Fecha as fecha, raa.Numero_Folio as folio, rat.Nombre as tipo, rco.Nombre as condicion
...
bitacora("Busca reporte RA por condicion ","Buscar",$conexion);
		...
		$aco1=0;
		include("conexion.php");	
		$conm="select DISTINCT ciud.Id_Ciudad as idti, ciud.Nombre as Nombre
				from ra_actividad raa, 
				ra_tipo rat,
				aldea ald,
				ra_accion_actividad rac,
...
$_SESSION["nombres"]=$nombres;
 ?>
							...
							<img id="grafico" src="graficoBarCiu.php?var=<?php echo time(); ?>" />
							</div>
	</div>	
...
function traeListado(){
			...
			objeto_ajax.open("GET", "trae_RACiudad.php?hora="+hora+"&fecha1="+fecha1+"&fecha2="+fecha2+"&muni="+aldea1,true);

...
<div class="row-fluid">
			<div class="span12">				
					 <div class="widget-header widget-header-small header-color-blue">
						 <h5><b>Gestión de municipio</b></h5>
					 </div>
					...
					<form action="" class="form-horizontal" name="formulario" id="formu" method="post"> 
							...
							<table class="table  table-condensed " style=" font-weight: bold;" >
										<tr>
											<td style="padding: 8px 5px;">Nombre de municipio</td>
											<td style="padding: 8px 100px; ">
											<input  style="width:180px;" type="text" id="municipio" name="municipio" onfocus='blanco(this)' title="Ingrese los Datos" />
											</td>
											
		
										</tr>
										<tr>
											<td style="padding: 8px 5px;">Seleccione el estado</td>
											<td style="padding: 8px 100px; ">
												<select data-placeholder="Seleccione" id="estado" name="estado"  class="chzn-select" >
									...
									<div align="center">
										<div class="btn-group">
											...
											<button type="button" class="btn btn-info" value="Guardar" onClick="guardarMunicipio(document.formulario)">Registrar</button>
...
function traeListado(){
			...
			objeto_ajax.open("GET", "man_lista_municipios.php?hora="+hora,true);
